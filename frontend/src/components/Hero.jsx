  ...
  return (
    <div className="container 2xl:px-20 mx-auto my-10">
      <div className="bg-gradient-to-r from-purple-800 to-purple-950 text-white py-16 text-center mx-2 rounded-xl">
        ...
        <div className="flex items-center justify-between bg-white text-gray-600 max-w-xl rounded pl-4 mx-4 sm:mx-auto">
          ...
          <button
            onClick={onSearch}
            className="bg-green-600 font-semibold px-6 py-2 rounded text-white m-1"
          >
            Search
          </button>
        </div>
